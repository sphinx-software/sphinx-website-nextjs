...
const CompanyOverview: FunctionComponent = () => {
  ...
  return (
    <Element name={homeMenu.COMPANY_OVERVIEW}>
      <section className='bg-white' id={'overview'}>
        <div className='mx-auto max-w-7xl px-6 xl:px-0 -mt-1'>
          <div className='flex items-center flex-col md:flex-row-reverse md:justify-between items-center'>
            <div className='flex-1 flex justify-end'>
              <div className={styles.overViewContent}>
                <div className='md:pl-4 lg:pl-10 lg:pr-4 mt-20 md:mt-0 lg:mt-20'>
                  ...
                  >
                    <p className='text-16 text-black-50 leading-32 mt-3'>
                      ...
                      only a team of guys who young, enthusiastic, and
                      passionate about computer science but also home to many
                      young architectures since they were in 1st year of the
                      university until they become experts.
                    </p>
                  </ScrollAnimation>
                  <ScrollAnimation
                    animateIn='animate__fadeIn'
            ...
            <div className='flex-1 my-20 md:my-40 flex justify-start'>
