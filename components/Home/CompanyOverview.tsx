...
const CompanyOverview: FunctionComponent = () => {
  return (
    <section className='bg-white'>
      <div className='mx-auto max-w-7xl px-2 md:px-0  pt-12 py-12 md:py-28'>
        <div className='flex items-center flex-col md:flex-row-reverse md:justify-between'>
          ...
          >
            <div className='pl-4 lg:pl-10 lg:pr-4'>
              ...
              <p className='text-16 text-black-50 leading-32'>
                ...
                they were in 1st year of the university until they become
                experts.
              </p>
          ...
          <div className={classes([styles.companyOverviewImage, 'w-1/2'])}>
