            ...
            <div className={styles.workingContent}>
                <div>
                    ...
                    <div className="flex w-full h-auto pb-250">
                        ...
                        <div className={"flex flex-col justify-star w-full md:w-1/2"}>
                            <div className={'flex justify-start items-end w-full flex-col'} style={{width: 536, height: 536, minWidth: 536}}>
