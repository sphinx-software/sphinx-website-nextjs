    ...
    >
      <div className={'mx-auto max-w-7xl flex items-center flex-col'}>
        <div className={'w-full md:w-2/3 mx:auto pt-44'}>
          <p className='text-center text-36 leading-48 md:leading-32 text-white pb-4 md:pb-6'>
            Leading technology company in Vietnam
          </p>
          <p className='text-center text-gray-350 text-16 leading-32 text-white pb-4 md:pb-6'>
